...
(function() {
  var addKeyValue, applyArrayChange, applyBranchChange, applyLeafChange, changeset, compare, compareArray, compareObject, comparePrimitives, convertArrayToObj, diffs, getKey, getTypeOfObj, indexOfItemInArray, isEmbeddedKey, modifyKeyValue, newObj, oldObj, parseEmbeddedKeyValue, removeKey, revertArrayChange, revertBranchChange, revertLeafChange, util, _;
  ...
  applyLeafChange = function(obj, change) {
    ...
    switch (type) {
      ...
      case exports.op.UPDATE:
        return modifyKeyValue(obj, key, value);
      case exports.op.REMOVE:
  ...
  applyArrayChange = function(arr, change) {
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      ...
      if (subchange.value != null) {
        ...
        _results.push(exports.applyChanges(element, subchange.changes));
      }
    }
    return _results;
  };
  ...
  applyBranchChange = function(obj, change) {
    if (Array.isArray(obj)) {
      ...
      return exports.applyChanges(obj[change.key], change.changes);
    }
  };
  ...
  revertArrayChange = function(arr, change) {
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      ...
      if (subchange.value != null) {
        ...
        _results.push(exports.revertChanges(element, subchange.changes));
      }
    }
    return _results;
  };
  ...
  revertBranchChange = function(obj, change) {
    if (Array.isArray(obj)) {
      ...
      return exports.revertChanges(obj[change.key], change.changes);
    }
  };
  ...
  exports.applyChanges = function(obj, changeset) {
  ...
  exports.revertChanges = function(obj, changeset) {
    var change, _i, _len, _results;
    _results = [];
    for (_i = 0, _len = changeset.length; _i < _len; _i++) {
      change = changeset[_i];
  ...
  diffs = exports.diff(oldObj, newObj);

  console.log('diffs', util.inspect(diffs, {
    depth: 10
  }));
